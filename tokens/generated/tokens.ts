...
export const opacityDisabledDefault = 0.4; // Opacity for disabled component state. Applied as element-level opacity (opacity: 0.4) on the full component, not on individual fills, because disabled state dims all visual properties uniformly.
