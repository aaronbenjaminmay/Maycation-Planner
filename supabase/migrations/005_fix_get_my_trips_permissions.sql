-- Reset RPC security and grants for authenticated trip operations.
--
-- SQL Editor calls still have no auth.uid(); these functions are intended to
-- be called from the app with an authenticated Supabase session.
